...
method initialize Scripter aProjectEditor {
  ...
  setExtent (morph blocksFrame) nil (150 * scale) // initial height // xxx was 285
...
method fixLayout Scripter {
  ...
  if (and ((height morph) > 120) (blocksHeight > ((height morph) - 100))) {
	blocksHeight = ((height morph) - 100)
  }
...
method scriptChanged Scripter {
  incrementEditCount projectEditor
  saveNeeded = true
}
